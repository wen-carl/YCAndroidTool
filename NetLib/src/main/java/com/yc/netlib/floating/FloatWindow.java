    ...
    public static class B {
        ...
        public B setWidth(@Screen.screenType int screenType, float ratio) {
            mWidth = (int) ((screenType == Screen.width ?
                    FloatUtils.getScreenWidth(mApplicationContext) :
                    FloatUtils.getScreenHeight(mApplicationContext)) * ratio);
            return this;
        }
        ...
        public void build() {
            ...
            if (mView == null) {
                mView = FloatUtils.inflate(mApplicationContext, mLayoutId);
            }
